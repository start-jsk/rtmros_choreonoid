...
sed -i -e "s@/home/player/ros/indigo/src/rtm-ros-robotics/rtmros_choreonoid/hrpsys_choreonoid/PDcontroller.so@PDcontroller@" ${CNOID_FILE}
sed -i -e "s@/home/player/ros/indigo/src/rtm-ros-robotics/rtmros_choreonoid/hrpsys_ros_bridge_jvrc/config/SensorReaderRTC.PD.conf@SensorReaderRTC.PD.conf@" ${CNOID_FILE}
